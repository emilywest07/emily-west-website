...
export const researchClaims: ResearchClaim[] = [
  {
    ...
    works: [
      {
        id: "beyond-belief",
        title: "Beyond Belief: Explanatory Frameworks as Justificatory Architecture",
        status: "Theory Paper",
